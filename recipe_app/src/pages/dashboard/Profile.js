...
const Profile  = ()=>{
    ...
    useEffect(()=>{
       fetch('https://phone-pocket-backend.herokuapp.com/mycontacts',{
           method:"POST",
           headers:{
    ...
    useEffect(()=>{
       if(image){
        ...
        .then(data=>{
           ...
           fetch('https://phone-pocket-backend.herokuapp.com/updatepic',{
               method:"put",
               headers:{
       ...
       <div style={{maxWidth:"550px",margin:"0px auto"}}>
           <div style={{
            ...
            <div style={{
               ...
               <div style={{marginTop:"50px", marginLeft:"4%"}}>
            ...
            {/* <h3 style={{textAlign:"center", color:"#2E357E", fontSize:"40px"}}></h3>  */}
